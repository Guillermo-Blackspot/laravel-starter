@extends('app.layouts.frontend.adminto_public')
    ...
    <div class="wrapper-page">
            ...
            <div class="p-20">
                <form class="form-horizontal m-t-20" action="{{ route('auth.login.post') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <div class="col-xs-12">
                            <input class="form-control" name="password" type="password" required="" placeholder="ContraseÃ±a" value="{{ old('password') }}">
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <p class="text-muted">Aún tienes una cuenta? <a href="page-register.html" class="text-primary m-l-5"><b>Registrarse</b></a></p>
            </div>
        </div>
